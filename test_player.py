...
EXPENSIVE_TEMPLE = Card("Temple", C.CIVIC, points = 4, cost = [R.COAL], money_cost=1)
...
def test_Player__has_resources_for_card__with_single_resource(player):
    ...
    # expect
    assert player.has_resources_for_card([R.COAL], resource_provides)
...
def test_Player__has_resources_for_card__with_multiple_resources(player):
    ...
    # expect
    assert player.has_resources_for_card([R.COAL, R.SILK], resource_provides)
...
def test_Player__has_resources_for_card__with_resource_tuple_False(player):
    ...
    # expect
    assert False == player.has_resources_for_card([R.COAL, R.SILK], resource_provides)
...
def test_Player__has_resources_for_card__with_multiple_costs(player):
    ...
    # expect
    assert player.has_resources_for_card([R.COAL, R.COAL], resource_provides)
...
def test_Player__has_resources_for_card__combo1(player):
    ...
    # expect
    assert player.has_resources_for_card([R.COAL, R.COAL, R.SILK, R.STONE], resource_provides)
